...
function displayHelp() {
  ...
  envTable.push(
    [`${chalk.yellow('OPENROUTER_API_KEY')}${chalk.reset('')}`, 
     `${chalk.white('Your OpenRouter API key (get from openrouter.ai)')}${chalk.reset('')}`, 
     `${chalk.dim('Required')}${chalk.reset('')}`],
    [`${chalk.yellow('PERPLEXITY_API_KEY')}${chalk.reset('')}`, 
     `${chalk.white('Your Perplexity API key (get from perplexity.ai)')}${chalk.reset('')}`, 
     `${chalk.dim('Optional')}${chalk.reset('')}`],
    [`${chalk.yellow('OPENROUTER_API_BASE')}${chalk.reset('')}`, 
     `${chalk.white('OpenRouter API base URL (default: https://openrouter.ai/api/v1)')}${chalk.reset('')}`, 
     `${chalk.dim(`Default: ${CONFIG.openrouterApiBase}`)}${chalk.reset('')}`],
    [`${chalk.yellow('OPENROUTER_MODEL')}${chalk.reset('')}`, 
     `${chalk.white('Model to use via OpenRouter (e.g., openai/gpt-4o)')}${chalk.reset('')}`, 
     `${chalk.dim(`Default: ${CONFIG.openrouterModel}`)}${chalk.reset('')}`],
    [`${chalk.yellow('PERPLEXITY_MODEL')}${chalk.reset('')}`, 
     `${chalk.white('Model to use for Perplexity (default: sonar-medium-online)')}${chalk.reset('')}`, 
     `${chalk.dim(`Default: ${CONFIG.perplexityModel}`)}${chalk.reset('')}`],
